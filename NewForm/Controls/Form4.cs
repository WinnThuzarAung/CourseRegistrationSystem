...
namespace NewForm
{
    public partial class Form4 : Form
    {
        ...
        {
            SqlConnection c = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\CoursesRegirstration\my project\my project\myproject.mdf;Integrated Security=True;Connect Timeout=30");
            c.Open();
