...
namespace NewForm
{
    public partial class Form3 : Form
    {
        ...
        {
            SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\v11.0;AttachDbFilename=D:\CoursesRegirstration\my project\my project\myproject.mdf;Integrated Security=True;Connect Timeout=30");
            con.Open();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
           ...
           /* SqlDataAdapter da1 = new SqlDataAdapter("select * from levels", conn);*/
            SqlDataAdapter da1=new SqlDataAdapter("select levels.level_id,levels.level_name,courses.course_name,levels.duration,levels.fees from levels inner join courses on levels.course_id=courses.course_id",conn);
